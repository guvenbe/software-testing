...
class CustomerRepositoryTest {
    ...
    void itShouldSelectCustomerByPhoneNumber() {
        ...
        assertThat(optionalCustomer)
                .isPresent()
                .hasValueSatisfying(
                        c->assertThat(c).isEqualToComparingFieldByField(customer));

    }

    @Test
    void itShouldNotSelectCustomerByPhoneNumberWhenNumberDoesNotExsit() {
        //Given
...
//                    assertThat(c.getPhoneNumber()).isEqualTo(customer.getPhoneNumber());
    ...
    void itShouldNotSaveCustomerWhenPhoneNumberIsNull() {
        //Given
        UUID id = UUID.randomUUID();
        Customer customer = new Customer(id, "Bob", null);
        //When
        //Then
        assertThatThrownBy(()->underTest.save(customer))
